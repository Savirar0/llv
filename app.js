document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Set the date to April 16, 2025, at 3 PM
  const targetDate = "2025-04-16T15:00:00"; // ISO 8601 format
  setInterval(() => timeElapse(targetDate), 1000);
  ...
  const textAnimate = async () => {
    ...
    const memorialDate = new Date(memorialInput.value || targetDate);
